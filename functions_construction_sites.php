...
function display_construction_site_popup(){
    ...
    <div id="popup_cs_wrapper" class="popup popup_construction_site_wrapper">
        ...
        <div class="popup_section section_1">
            ...
            <div class="popup_header_welcome">Bienvenue chez <b>Koncrete</b> ! </div>
        </div>
        <div class="popup_section section_2">
            <div class="popup_column col_1">
                <div class="section_header">Mon code postal</div>
            ...
            <div class="popup_column col_3">
                ...
                <div class="popup_section_text popup_col_text"> pour sélectionner votre chantier</div>
            </div>
        </div> 
        <div class="popup_section section_3">
            <img src="https://koncrete.fr/wp-content/uploads/2022/08/contour_france-2.png" height="80" width="80">
            <div class="popup_section_text">
                Pour vous proposez les meilleurs matériaux au plus près de chez vous, nous vous avons rassemblé les réferences de nombreux distributeurs. Pour avoir les matériaux les moins chers et les plus près de chez vous, indiquez votre code postal.
            </div>
        </div> 
    </div>
