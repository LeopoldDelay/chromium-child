...
function wc_add_to_cart_message_filter($message, $product_id = null) {
    ...
    $message = sprintf(  '✓ %s <div class="button-popup-wrapper"><a href="%s/livraison" class="button-checkout-pop button-popup">%s</a>&nbsp;<a href="%s" class="button-cart-popup button-popup">%s</a></div>',
                    esc_html( $added_text ),
                    esc_url( wc_get_page_permalink( 'livraison' ) ),
                    esc_html__( 'Passer à la commande', 'woocommerce' ),
